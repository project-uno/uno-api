...
ActiveRecord::Schema.define(version: 20141029105811) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "course_assigned_works", force: true do |t|
  ...
  create_table "course_work_categories", force: true do |t|
    t.string   "name"
    t.decimal  "weight"
